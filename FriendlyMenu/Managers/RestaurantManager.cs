...
namespace Managers
{
  public class RestaurantManager : IRestaurantManager
  {
    ...
    public async Task<HomePageVM> GetHomePageByRestaurantId(int restaurantId)
    {
      HomePageDM homePageDM = await _restaurantDataAccessor.GetHomePageDm(restaurantId);
      HomePageVM homePageVM = BuildHomePageVM(homePageDM);

      return homePageVM;

    }

    private HomePageVM BuildHomePageVM(HomePageDM homePageDM)
    {
